...
export function DraftRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): DraftRequest {
    ...
    return {
        ...
        'lines': ((json['lines'] as Array<any>).map(DraftLineRequestFromJSON)),
    };
}

export function DraftRequestToJSON(value?: DraftRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'lines': ((value.lines as Array<any>).map(DraftLineRequestToJSON)),
    };
}
