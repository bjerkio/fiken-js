...
export function PurchaseResultFromJSON(json: any): PurchaseResult {
    return PurchaseResultFromJSONTyped(json, false);
}

export function PurchaseResultFromJSONTyped(json: any, ignoreDiscriminator: boolean): PurchaseResult {
    ...
    return {
        ...
        'supplier': !exists(json, 'supplier') ? undefined : ContactFromJSON(json['supplier']),
        ...
        'purchaseAttachments': !exists(json, 'purchaseAttachments') ? undefined : ((json['purchaseAttachments'] as Array<any>).map(AttachmentFromJSON)),
        'kid': !exists(json, 'kid') ? undefined : json['kid'],
        'project': !exists(json, 'project') ? undefined : ((json['project'] as Array<any>).map(ProjectResultFromJSON)),
    };
}

export function PurchaseResultToJSON(value?: PurchaseResult | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'supplier': ContactToJSON(value.supplier),
        ...
        'purchaseAttachments': value.purchaseAttachments === undefined ? undefined : ((value.purchaseAttachments as Array<any>).map(AttachmentToJSON)),
        'kid': value.kid,
        'project': value.project === undefined ? undefined : ((value.project as Array<any>).map(ProjectResultToJSON)),
    };
}
