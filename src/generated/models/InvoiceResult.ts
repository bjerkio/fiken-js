...
export function InvoiceResultFromJSON(json: any): InvoiceResult {
    return InvoiceResultFromJSONTyped(json, false);
}

export function InvoiceResultFromJSONTyped(json: any, ignoreDiscriminator: boolean): InvoiceResult {
    ...
    return {
        ...
        'originalDueDate': !exists(json, 'originalDueDate') ? undefined : (new Date(json['originalDueDate'])),
        'net': !exists(json, 'net') ? undefined : json['net'],
        'vat': !exists(json, 'vat') ? undefined : json['vat'],
        'gross': !exists(json, 'gross') ? undefined : json['gross'],
        'netInNok': !exists(json, 'netInNok') ? undefined : json['netInNok'],
        'vatInNok': !exists(json, 'vatInNok') ? undefined : json['vatInNok'],
        'grossInNok': !exists(json, 'grossInNok') ? undefined : json['grossInNok'],
        'cash': !exists(json, 'cash') ? undefined : json['cash'],
        'invoiceText': !exists(json, 'invoiceText') ? undefined : json['invoiceText'],
        ...
        'orderReference': !exists(json, 'orderReference') ? undefined : json['orderReference'],
        'address': !exists(json, 'address') ? undefined : AddressFromJSON(json['address']),
        'lines': !exists(json, 'lines') ? undefined : ((json['lines'] as Array<any>).map(InvoiceLineResultFromJSON)),
        'currency': !exists(json, 'currency') ? undefined : json['currency'],
        'bankAccountNumber': !exists(json, 'bankAccountNumber') ? undefined : json['bankAccountNumber'],
        'sentManually': !exists(json, 'sentManually') ? undefined : json['sentManually'],
        'invoicePdf': !exists(json, 'invoicePdf') ? undefined : AttachmentFromJSON(json['invoicePdf']),
        'associatedCreditNotes': !exists(json, 'associatedCreditNotes') ? undefined : json['associatedCreditNotes'],
        'attachments': !exists(json, 'attachments') ? undefined : ((json['attachments'] as Array<any>).map(AttachmentFromJSON)),
        'customer': !exists(json, 'customer') ? undefined : ContactFromJSON(json['customer']),
        'sale': !exists(json, 'sale') ? undefined : SaleResultFromJSON(json['sale']),
        'project': !exists(json, 'project') ? undefined : ProjectResultFromJSON(json['project']),
    };
}

export function InvoiceResultToJSON(value?: InvoiceResult | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'originalDueDate': value.originalDueDate === undefined ? undefined : (value.originalDueDate.toISOString().substr(0,10)),
        'net': value.net,
        'vat': value.vat,
        'gross': value.gross,
        'netInNok': value.netInNok,
        'vatInNok': value.vatInNok,
        'grossInNok': value.grossInNok,
        'cash': value.cash,
        ...
        'lines': value.lines === undefined ? undefined : ((value.lines as Array<any>).map(InvoiceLineResultToJSON)),
        'currency': value.currency,
        'bankAccountNumber': value.bankAccountNumber,
        'sentManually': value.sentManually,
        'invoicePdf': AttachmentToJSON(value.invoicePdf),
        'associatedCreditNotes': value.associatedCreditNotes,
        'attachments': value.attachments === undefined ? undefined : ((value.attachments as Array<any>).map(AttachmentToJSON)),
        'customer': ContactToJSON(value.customer),
        'sale': SaleResultToJSON(value.sale),
        'project': ProjectResultToJSON(value.project),
    };
}
