...
export function InvoiceishDraftRequestFromJSON(json: any): InvoiceishDraftRequest {
    return InvoiceishDraftRequestFromJSONTyped(json, false);
}

export function InvoiceishDraftRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): InvoiceishDraftRequest {
    ...
    return {
        ...
        'daysUntilDueDate': json['daysUntilDueDate'],
...
export function InvoiceishDraftRequestToJSON(value?: InvoiceishDraftRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
