...
export function DraftResultFromJSONTyped(json: any, ignoreDiscriminator: boolean): DraftResult {
    ...
    return {
        ...
        'invoiceIssueDate': !exists(json, 'invoiceIssueDate') ? undefined : (new Date(json['invoiceIssueDate'])),
        ...
        'lines': !exists(json, 'lines') ? undefined : ((json['lines'] as Array<any>).map(DraftLineResultFromJSON)),
    };
}

export function DraftResultToJSON(value?: DraftResult | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'uuid': value.uuid,
        'invoiceIssueDate': value.invoiceIssueDate === undefined ? undefined : (value.invoiceIssueDate.toISOString().substr(0,10)),
        ...
        'lines': value.lines === undefined ? undefined : ((value.lines as Array<any>).map(DraftLineResultToJSON)),
    };
}
