...
export function SaleResultFromJSON(json: any): SaleResult {
    return SaleResultFromJSONTyped(json, false);
}

export function SaleResultFromJSONTyped(json: any, ignoreDiscriminator: boolean): SaleResult {
    ...
    return {
        ...
        'saleNumber': !exists(json, 'saleNumber') ? undefined : json['saleNumber'],
        'date': !exists(json, 'date') ? undefined : (new Date(json['date'])),
        'kind': !exists(json, 'kind') ? undefined : json['kind'],
        'netAmount': !exists(json, 'netAmount') ? undefined : json['netAmount'],
        'vatAmount': !exists(json, 'vatAmount') ? undefined : json['vatAmount'],
        'settled': !exists(json, 'settled') ? undefined : json['settled'],
        'writeOff': !exists(json, 'writeOff') ? undefined : json['writeOff'],
        'totalPaid': !exists(json, 'totalPaid') ? undefined : json['totalPaid'],
        'totalPaidInCurrency': !exists(json, 'totalPaidInCurrency') ? undefined : json['totalPaidInCurrency'],
        'outstandingBalance': !exists(json, 'outstandingBalance') ? undefined : json['outstandingBalance'],
        'lines': !exists(json, 'lines') ? undefined : ((json['lines'] as Array<any>).map(OrderLineFromJSON)),
        ...
        'salePayments': !exists(json, 'salePayments') ? undefined : ((json['salePayments'] as Array<any>).map(PaymentFromJSON)),
        'saleAttachments': !exists(json, 'saleAttachments') ? undefined : ((json['saleAttachments'] as Array<any>).map(AttachmentFromJSON)),
...
export function SaleResultToJSON(value?: SaleResult | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'lines': value.lines === undefined ? undefined : ((value.lines as Array<any>).map(OrderLineToJSON)),
        ...
        'salePayments': value.salePayments === undefined ? undefined : ((value.salePayments as Array<any>).map(PaymentToJSON)),
        'saleAttachments': value.saleAttachments === undefined ? undefined : ((value.saleAttachments as Array<any>).map(AttachmentToJSON)),
