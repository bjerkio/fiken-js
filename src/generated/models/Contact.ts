...
export function ContactFromJSONTyped(json: any, ignoreDiscriminator: boolean): Contact {
    ...
    return {
        ...
        'customerAccountCode': !exists(json, 'customerAccountCode') ? undefined : json['customerAccountCode'],
        'phoneNumber': !exists(json, 'phoneNumber') ? undefined : json['phoneNumber'],
        'memberNumber': !exists(json, 'memberNumber') ? undefined : json['memberNumber'],
        'supplierNumber': !exists(json, 'supplierNumber') ? undefined : json['supplierNumber'],
        'supplierAccountCode': !exists(json, 'supplierAccountCode') ? undefined : json['supplierAccountCode'],
