...
* @enum {string}
*/
export enum SendCreditNoteRequestMethodEnum {
    Email = 'email',
    Ehf = 'ehf',
    Vipps = 'vipps',
    Sms = 'sms',
...
* @enum {string}
*/
export enum SendCreditNoteRequestEmailSendOptionEnum {
    DocumentLink = 'document_link',
    Attachment = 'attachment',
    Auto = 'auto'
}

export function SendCreditNoteRequestFromJSON(json: any): SendCreditNoteRequest {
    return SendCreditNoteRequestFromJSONTyped(json, false);
}

export function SendCreditNoteRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): SendCreditNoteRequest {
...
export function SendCreditNoteRequestToJSON(value?: SendCreditNoteRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
