...
* @enum {string}
*/
export enum BankAccountResultTypeEnum {
    Normal = 'normal',
...
export function BankAccountResultFromJSON(json: any): BankAccountResult {
    return BankAccountResultFromJSONTyped(json, false);
}

export function BankAccountResultFromJSONTyped(json: any, ignoreDiscriminator: boolean): BankAccountResult {
    ...
    return {
        ...
        'foreignService': !exists(json, 'foreignService') ? undefined : json['foreignService'],
        'type': !exists(json, 'type') ? undefined : json['type'],
        'reconciledBalance': !exists(json, 'reconciledBalance') ? undefined : json['reconciledBalance'],
        'reconciledDate': !exists(json, 'reconciledDate') ? undefined : (new Date(json['reconciledDate'])),
    };
}

export function BankAccountResultToJSON(value?: BankAccountResult | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'iban': value.iban,
        'bic': value.bic,
        'foreignService': value.foreignService,
        'type': value.type,
        'reconciledBalance': value.reconciledBalance,
        'reconciledDate': value.reconciledDate === undefined ? undefined : (value.reconciledDate.toISOString().substr(0,10)),
    };
}
