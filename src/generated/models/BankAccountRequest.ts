...
export interface BankAccountRequest {
     ...
     * @memberof BankAccountRequest
     */
    type: BankAccountRequestTypeEnum;
    /**
     * 
     * @type {boolean}
     * @memberof BankAccountRequest
...
* @enum {string}
*/
export enum BankAccountRequestTypeEnum {
    Normal = 'normal',
...
export function BankAccountRequestFromJSON(json: any): BankAccountRequest {
    return BankAccountRequestFromJSONTyped(json, false);
}

export function BankAccountRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): BankAccountRequest {
...
export function BankAccountRequestToJSON(value?: BankAccountRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
