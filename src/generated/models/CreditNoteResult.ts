...
export function CreditNoteResultFromJSON(json: any): CreditNoteResult {
    return CreditNoteResultFromJSONTyped(json, false);
}

export function CreditNoteResultFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreditNoteResult {
    ...
    return {
        ...
        'customer': ContactFromJSON(json['customer']),
        'net': json['net'],
        'vat': json['vat'],
        'gross': json['gross'],
        'netInNok': json['netInNok'],
        'vatInNok': json['vatInNok'],
        'grossInNok': json['grossInNok'],
        'creditNoteText': !exists(json, 'creditNoteText') ? undefined : json['creditNoteText'],
        ...
        'associatedInvoiceId': !exists(json, 'associatedInvoiceId') ? undefined : json['associatedInvoiceId'],
        'creditNotePdf': !exists(json, 'creditNotePdf') ? undefined : AttachmentFromJSON(json['creditNotePdf']),
        'project': !exists(json, 'project') ? undefined : ProjectResultFromJSON(json['project']),
    };
}

export function CreditNoteResultToJSON(value?: CreditNoteResult | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'creditNoteText': value.creditNoteText,
        ...
        'associatedInvoiceId': value.associatedInvoiceId,
        'creditNotePdf': AttachmentToJSON(value.creditNotePdf),
