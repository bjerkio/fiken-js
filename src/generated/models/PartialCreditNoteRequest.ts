...
export interface PartialCreditNoteRequest {
    ...
    /**
     * 
     * @type {Array<CreditNoteLineResult>}
     * @memberof PartialCreditNoteRequest
     */
    lines: Array<CreditNoteLineResult>;
}

export function PartialCreditNoteRequestFromJSON(json: any): PartialCreditNoteRequest {
    return PartialCreditNoteRequestFromJSONTyped(json, false);
}

export function PartialCreditNoteRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PartialCreditNoteRequest {
    ...
    return {
        ...
        'lines': ((json['lines'] as Array<any>).map(CreditNoteLineResultFromJSON)),
    };
}

export function PartialCreditNoteRequestToJSON(value?: PartialCreditNoteRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'issueDate': (value.issueDate.toISOString().substr(0,10)),
        'invoiceId': value.invoiceId,
        'contactId': value.contactId,
        'contactPersonId': value.contactPersonId,
        'creditNoteText': value.creditNoteText,
        'lines': ((value.lines as Array<any>).map(CreditNoteLineResultToJSON)),
    };
}
