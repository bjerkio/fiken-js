...
export function InvoiceLineResultFromJSON(json: any): InvoiceLineResult {
    return InvoiceLineResultFromJSONTyped(json, false);
}

export function InvoiceLineResultFromJSONTyped(json: any, ignoreDiscriminator: boolean): InvoiceLineResult {
    ...
    return {
        ...
        'vatInPercent': !exists(json, 'vatInPercent') ? undefined : json['vatInPercent'],
        ...
        'incomeAccount': !exists(json, 'incomeAccount') ? undefined : json['incomeAccount'],
    };
}

export function InvoiceLineResultToJSON(value?: InvoiceLineResult | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'vatInPercent': value.vatInPercent,
