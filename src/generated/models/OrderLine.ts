...
export function OrderLineFromJSONTyped(json: any, ignoreDiscriminator: boolean): OrderLine {
    ...
    return {
        ...
        'netPriceInCurrency': !exists(json, 'netPriceInCurrency') ? undefined : json['netPriceInCurrency'],
        'vatInCurrency': !exists(json, 'vatInCurrency') ? undefined : json['vatInCurrency'],
...
export function OrderLineToJSON(value?: OrderLine | null): any {
    ...
    return {
        ...
        'netPriceInCurrency': value.netPriceInCurrency,
        'vatInCurrency': value.vatInCurrency,
