...
export function InvoiceishDraftResultFromJSON(json: any): InvoiceishDraftResult {
    return InvoiceishDraftResultFromJSONTyped(json, false);
}

export function InvoiceishDraftResultFromJSONTyped(json: any, ignoreDiscriminator: boolean): InvoiceishDraftResult {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'draftId': !exists(json, 'draftId') ? undefined : json['draftId'],
        'uuid': !exists(json, 'uuid') ? undefined : json['uuid'],
        'type': !exists(json, 'type') ? undefined : json['type'],
        'issueDate': !exists(json, 'issueDate') ? undefined : (new Date(json['issueDate'])),
        'daysUntilDueDate': !exists(json, 'daysUntilDueDate') ? undefined : json['daysUntilDueDate'],
        ...
        'lines': !exists(json, 'lines') ? undefined : ((json['lines'] as Array<any>).map(InvoiceishDraftLineFromJSON)),
        ...
        'customers': !exists(json, 'customers') ? undefined : ((json['customers'] as Array<any>).map(ContactFromJSON)),
        'attachments': !exists(json, 'attachments') ? undefined : ((json['attachments'] as Array<any>).map(AttachmentFromJSON)),
        'createdFromInvoiceId': !exists(json, 'createdFromInvoiceId') ? undefined : json['createdFromInvoiceId'],
        'projectId': !exists(json, 'projectId') ? undefined : json['projectId'],
    };
}

export function InvoiceishDraftResultToJSON(value?: InvoiceishDraftResult | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'daysUntilDueDate': value.daysUntilDueDate,
        'invoiceText': value.invoiceText,
        'currency': value.currency,
        'yourReference': value.yourReference,
        'ourReference': value.ourReference,
        'orderReference': value.orderReference,
        'lines': value.lines === undefined ? undefined : ((value.lines as Array<any>).map(InvoiceishDraftLineToJSON)),
        'bankAccountNumber': value.bankAccountNumber,
        'iban': value.iban,
        'bic': value.bic,
        'paymentAccount': value.paymentAccount,
        'customers': value.customers === undefined ? undefined : ((value.customers as Array<any>).map(ContactToJSON)),
        'attachments': value.attachments === undefined ? undefined : ((value.attachments as Array<any>).map(AttachmentToJSON)),
        'createdFromInvoiceId': value.createdFromInvoiceId,
