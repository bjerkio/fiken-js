...
* @enum {string}
*/
export enum CompanyVatTypeEnum {
    False = 'false',
    Yearly = 'yearly',
    Monthly = 'monthly',
...
export function CompanyFromJSONTyped(json: any, ignoreDiscriminator: boolean): Company {
    ...
    return {
        ...
        'hasApiAccess': !exists(json, 'hasApiAccess') ? undefined : json['hasApiAccess'],
        'testCompany': !exists(json, 'testCompany') ? undefined : json['testCompany'],
        'accountingStartDate': !exists(json, 'accountingStartDate') ? undefined : (new Date(json['accountingStartDate'])),
    };
}
...
export function CompanyToJSON(value?: Company | null): any {
    ...
    return {
        ...
        'testCompany': value.testCompany,
        'accountingStartDate': value.accountingStartDate === undefined ? undefined : (value.accountingStartDate.toISOString().substr(0,10)),
    };
}
