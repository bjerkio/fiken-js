...
* @enum {string}
*/
export enum SendInvoiceRequestMethodEnum {
    Email = 'email',
    Ehf = 'ehf',
    Vipps = 'vipps',
    Sms = 'sms',
...
* @enum {string}
*/
export enum SendInvoiceRequestEmailSendOptionEnum {
    DocumentLink = 'document_link',
    Attachment = 'attachment',
    Auto = 'auto'
}

export function SendInvoiceRequestFromJSON(json: any): SendInvoiceRequest {
    return SendInvoiceRequestFromJSONTyped(json, false);
}

export function SendInvoiceRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): SendInvoiceRequest {
...
export function SendInvoiceRequestToJSON(value?: SendInvoiceRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
