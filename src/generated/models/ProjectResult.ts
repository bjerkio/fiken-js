...
export function ProjectResultFromJSON(json: any): ProjectResult {
    return ProjectResultFromJSONTyped(json, false);
}

export function ProjectResultFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProjectResult {
...
export function ProjectResultToJSON(value?: ProjectResult | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
