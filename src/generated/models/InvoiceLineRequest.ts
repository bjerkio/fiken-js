...
export function InvoiceLineRequestFromJSON(json: any): InvoiceLineRequest {
    return InvoiceLineRequestFromJSONTyped(json, false);
}

export function InvoiceLineRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): InvoiceLineRequest {
...
export function InvoiceLineRequestToJSON(value?: InvoiceLineRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
