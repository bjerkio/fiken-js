...
export interface AddAttachmentToOrderConfirmationDraftRequest {
    companySlug: string;
    draftId: number;
    filename?: string;
    comment?: string;
...
export interface CreateOrderConfirmationDraftRequest {
    companySlug: string;
    invoiceishDraftRequest: InvoiceishDraftRequest;
}

export interface CreateOrderConfirmationFromDraftRequest {
    companySlug: string;
    draftId: number;
}

export interface DeleteOrderConfirmationDraftRequest {
    companySlug: string;
    draftId: number;
}
...
export interface GetOrderConfirmationDraftRequest {
    companySlug: string;
    draftId: number;
}

export interface GetOrderConfirmationDraftAttachmentsRequest {
    companySlug: string;
    draftId: number;
}

export interface GetOrderConfirmationDraftsRequest {
    companySlug: string;
    page?: number;
    pageSize?: number;
}

export interface GetOrderConfirmationsRequest {
    companySlug: string;
    page?: number;
    pageSize?: number;
}

export interface UpdateOrderConfirmationDraftRequest {
    companySlug: string;
    draftId: number;
    invoiceishDraftRequest: InvoiceishDraftRequest;
}
 ...
 * 
 */
export class OrderConfirmationsApi extends runtime.BaseAPI {

    /**
     * Creates and adds a new attachment to an order confirmation draft
     */
    async addAttachmentToOrderConfirmationDraftRaw(requestParameters: AddAttachmentToOrderConfirmationDraftRequest): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.companySlug === null || requestParameters.companySlug === undefined) {
            throw new runtime.RequiredError('companySlug','Required parameter requestParameters.companySlug was null or undefined when calling addAttachmentToOrderConfirmationDraft.');
        }

        if (requestParameters.draftId === null || requestParameters.draftId === undefined) {
            throw new runtime.RequiredError('draftId','Required parameter requestParameters.draftId was null or undefined when calling addAttachmentToOrderConfirmationDraft.');
        }
        ...
        const response = await this.request({
            path: `/companies/{companySlug}/orderConfirmations/drafts/{draftId}/attachments`.replace(`{${"companySlug"}}`, encodeURIComponent(String(requestParameters.companySlug))).replace(`{${"draftId"}}`, encodeURIComponent(String(requestParameters.draftId))),
            method: 'POST',
     ...
     * Creates and adds a new attachment to an order confirmation draft
     */
    async addAttachmentToOrderConfirmationDraft(requestParameters: AddAttachmentToOrderConfirmationDraftRequest): Promise<void> {
        await this.addAttachmentToOrderConfirmationDraftRaw(requestParameters);
    }

    /**
     * Creates an order confirmation draft.
     */
    async createOrderConfirmationDraftRaw(requestParameters: CreateOrderConfirmationDraftRequest): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.companySlug === null || requestParameters.companySlug === undefined) {
            throw new runtime.RequiredError('companySlug','Required parameter requestParameters.companySlug was null or undefined when calling createOrderConfirmationDraft.');
        }

        if (requestParameters.invoiceishDraftRequest === null || requestParameters.invoiceishDraftRequest === undefined) {
            throw new runtime.RequiredError('invoiceishDraftRequest','Required parameter requestParameters.invoiceishDraftRequest was null or undefined when calling createOrderConfirmationDraft.');
        }
        ...
        const response = await this.request({
            path: `/companies/{companySlug}/orderConfirmations/drafts`.replace(`{${"companySlug"}}`, encodeURIComponent(String(requestParameters.companySlug))),
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
     ...
     * Creates an order confirmation draft.
     */
    async createOrderConfirmationDraft(requestParameters: CreateOrderConfirmationDraftRequest): Promise<void> {
        await this.createOrderConfirmationDraftRaw(requestParameters);
    }

    /**
     * Creates an order confirmation from an already created draft.
     */
    async createOrderConfirmationFromDraftRaw(requestParameters: CreateOrderConfirmationFromDraftRequest): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.companySlug === null || requestParameters.companySlug === undefined) {
            throw new runtime.RequiredError('companySlug','Required parameter requestParameters.companySlug was null or undefined when calling createOrderConfirmationFromDraft.');
        }

        if (requestParameters.draftId === null || requestParameters.draftId === undefined) {
            throw new runtime.RequiredError('draftId','Required parameter requestParameters.draftId was null or undefined when calling createOrderConfirmationFromDraft.');
        }
        ...
        const response = await this.request({
            path: `/companies/{companySlug}/orderConfirmations/drafts/{draftId}/createOrderConfirmation`.replace(`{${"companySlug"}}`, encodeURIComponent(String(requestParameters.companySlug))).replace(`{${"draftId"}}`, encodeURIComponent(String(requestParameters.draftId))),
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
        });
     ...
     * Creates an order confirmation from an already created draft.
     */
    async createOrderConfirmationFromDraft(requestParameters: CreateOrderConfirmationFromDraftRequest): Promise<void> {
        await this.createOrderConfirmationFromDraftRaw(requestParameters);
    }

    /**
     * Delete order confirmation draft with specified id.
     */
    async deleteOrderConfirmationDraftRaw(requestParameters: DeleteOrderConfirmationDraftRequest): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.companySlug === null || requestParameters.companySlug === undefined) {
            throw new runtime.RequiredError('companySlug','Required parameter requestParameters.companySlug was null or undefined when calling deleteOrderConfirmationDraft.');
        }

        if (requestParameters.draftId === null || requestParameters.draftId === undefined) {
            throw new runtime.RequiredError('draftId','Required parameter requestParameters.draftId was null or undefined when calling deleteOrderConfirmationDraft.');
        }
        ...
        const response = await this.request({
            path: `/companies/{companySlug}/orderConfirmations/drafts/{draftId}`.replace(`{${"companySlug"}}`, encodeURIComponent(String(requestParameters.companySlug))).replace(`{${"draftId"}}`, encodeURIComponent(String(requestParameters.draftId))),
            method: 'DELETE',
            headers: headerParameters,
            query: queryParameters,
        });
     ...
     * Delete order confirmation draft with specified id.
     */
    async deleteOrderConfirmationDraft(requestParameters: DeleteOrderConfirmationDraftRequest): Promise<void> {
        await this.deleteOrderConfirmationDraftRaw(requestParameters);
    }

    /**
     * Returns order confirmation with specified id.
     */
    async getOrderConfirmationRaw(requestParameters: GetOrderConfirmationRequest): Promise<runtime.ApiResponse<OrderConfirmation>> {
        if (requestParameters.companySlug === null || requestParameters.companySlug === undefined) {
            throw new runtime.RequiredError('companySlug','Required parameter requestParameters.companySlug was null or undefined when calling getOrderConfirmation.');
        }

        if (requestParameters.confirmationId === null || requestParameters.confirmationId === undefined) {
            throw new runtime.RequiredError('confirmationId','Required parameter requestParameters.confirmationId was null or undefined when calling getOrderConfirmation.');
        }
        ...
        const response = await this.request({
            path: `/companies/{companySlug}/orderConfirmations/{confirmationId}`.replace(`{${"companySlug"}}`, encodeURIComponent(String(requestParameters.companySlug))).replace(`{${"confirmationId"}}`, encodeURIComponent(String(requestParameters.confirmationId))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        });
     ...
     * Returns order confirmation with specified id.
     */
    async getOrderConfirmation(requestParameters: GetOrderConfirmationRequest): Promise<OrderConfirmation> {
        const response = await this.getOrderConfirmationRaw(requestParameters);
     ...
     */
    async getOrderConfirmationDraftRaw(requestParameters: GetOrderConfirmationDraftRequest): Promise<runtime.ApiResponse<InvoiceishDraftResult>> {
        if (requestParameters.companySlug === null || requestParameters.companySlug === undefined) {
            throw new runtime.RequiredError('companySlug','Required parameter requestParameters.companySlug was null or undefined when calling getOrderConfirmationDraft.');
        }

        if (requestParameters.draftId === null || requestParameters.draftId === undefined) {
            throw new runtime.RequiredError('draftId','Required parameter requestParameters.draftId was null or undefined when calling getOrderConfirmationDraft.');
        }
     ...
     * Returns order confirmation draft with specified id.
     */
    async getOrderConfirmationDraft(requestParameters: GetOrderConfirmationDraftRequest): Promise<InvoiceishDraftResult> {
        const response = await this.getOrderConfirmationDraftRaw(requestParameters);
        return await response.value();
    }
     ...
     */
    async getOrderConfirmationDraftAttachmentsRaw(requestParameters: GetOrderConfirmationDraftAttachmentsRequest): Promise<runtime.ApiResponse<Array<Attachment>>> {
        if (requestParameters.companySlug === null || requestParameters.companySlug === undefined) {
            throw new runtime.RequiredError('companySlug','Required parameter requestParameters.companySlug was null or undefined when calling getOrderConfirmationDraftAttachments.');
        }

        if (requestParameters.draftId === null || requestParameters.draftId === undefined) {
            throw new runtime.RequiredError('draftId','Required parameter requestParameters.draftId was null or undefined when calling getOrderConfirmationDraftAttachments.');
        }
     ...
     * Returns all attachments for specified draft.
     */
    async getOrderConfirmationDraftAttachments(requestParameters: GetOrderConfirmationDraftAttachmentsRequest): Promise<Array<Attachment>> {
        const response = await this.getOrderConfirmationDraftAttachmentsRaw(requestParameters);
        return await response.value();
    }
     ...
     */
    async getOrderConfirmationDraftsRaw(requestParameters: GetOrderConfirmationDraftsRequest): Promise<runtime.ApiResponse<Array<InvoiceishDraftResult>>> {
        if (requestParameters.companySlug === null || requestParameters.companySlug === undefined) {
            throw new runtime.RequiredError('companySlug','Required parameter requestParameters.companySlug was null or undefined when calling getOrderConfirmationDrafts.');
        }
     ...
     * Returns all order confirmation drafts for given company.
     */
    async getOrderConfirmationDrafts(requestParameters: GetOrderConfirmationDraftsRequest): Promise<Array<InvoiceishDraftResult>> {
        const response = await this.getOrderConfirmationDraftsRaw(requestParameters);
        return await response.value();
    }
     ...
     */
    async getOrderConfirmationsRaw(requestParameters: GetOrderConfirmationsRequest): Promise<runtime.ApiResponse<Array<OrderConfirmation>>> {
        if (requestParameters.companySlug === null || requestParameters.companySlug === undefined) {
            throw new runtime.RequiredError('companySlug','Required parameter requestParameters.companySlug was null or undefined when calling getOrderConfirmations.');
        }
        ...
        const response = await this.request({
            path: `/companies/{companySlug}/orderConfirmations`.replace(`{${"companySlug"}}`, encodeURIComponent(String(requestParameters.companySlug))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        });

        return new runtime.JSONApiResponse(response, (jsonValue) => jsonValue.map(OrderConfirmationFromJSON));
    }

    /**
     * Returns all order confirmations for given company
     */
    async getOrderConfirmations(requestParameters: GetOrderConfirmationsRequest): Promise<Array<OrderConfirmation>> {
        const response = await this.getOrderConfirmationsRaw(requestParameters);
        return await response.value();
    }
     ...
     */
    async updateOrderConfirmationDraftRaw(requestParameters: UpdateOrderConfirmationDraftRequest): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.companySlug === null || requestParameters.companySlug === undefined) {
            throw new runtime.RequiredError('companySlug','Required parameter requestParameters.companySlug was null or undefined when calling updateOrderConfirmationDraft.');
        }

        if (requestParameters.draftId === null || requestParameters.draftId === undefined) {
            throw new runtime.RequiredError('draftId','Required parameter requestParameters.draftId was null or undefined when calling updateOrderConfirmationDraft.');
        }

        if (requestParameters.invoiceishDraftRequest === null || requestParameters.invoiceishDraftRequest === undefined) {
            throw new runtime.RequiredError('invoiceishDraftRequest','Required parameter requestParameters.invoiceishDraftRequest was null or undefined when calling updateOrderConfirmationDraft.');
        }
     ...
     * Updates order confirmation draft with provided id. 
     */
    async updateOrderConfirmationDraft(requestParameters: UpdateOrderConfirmationDraftRequest): Promise<void> {
        await this.updateOrderConfirmationDraftRaw(requestParameters);
    }
