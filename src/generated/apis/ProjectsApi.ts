...
export class ProjectsApi extends runtime.BaseAPI {
     ...
     */
    async createProjectRaw(requestParameters: CreateProjectRequest): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.companySlug === null || requestParameters.companySlug === undefined) {
            throw new runtime.RequiredError('companySlug','Required parameter requestParameters.companySlug was null or undefined when calling createProject.');
        }
        ...
        const response = await this.request({
            path: `/companies/{companySlug}/projects`.replace(`{${"companySlug"}}`, encodeURIComponent(String(requestParameters.companySlug))),
            method: 'POST',
     ...
     * Creates a new project
     */
    async createProject(requestParameters: CreateProjectRequest): Promise<void> {
        await this.createProjectRaw(requestParameters);
    }
    ...
    async deleteProjectRaw(requestParameters: DeleteProjectRequest): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.companySlug === null || requestParameters.companySlug === undefined) {
            throw new runtime.RequiredError('companySlug','Required parameter requestParameters.companySlug was null or undefined when calling deleteProject.');
        }
        ...
        const response = await this.request({
            path: `/companies/{companySlug}/projects/{projectId}`.replace(`{${"companySlug"}}`, encodeURIComponent(String(requestParameters.companySlug))).replace(`{${"projectId"}}`, encodeURIComponent(String(requestParameters.projectId))),
            method: 'DELETE',
            headers: headerParameters,
            query: queryParameters,
        });
     ...
     */
    async getProjectRaw(requestParameters: GetProjectRequest): Promise<runtime.ApiResponse<ProjectResult>> {
        if (requestParameters.companySlug === null || requestParameters.companySlug === undefined) {
            throw new runtime.RequiredError('companySlug','Required parameter requestParameters.companySlug was null or undefined when calling getProject.');
        }
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ProjectResultFromJSON(jsonValue));
    }

    /**
     * Returns project with specified id.
     */
    async getProject(requestParameters: GetProjectRequest): Promise<ProjectResult> {
     ...
     */
    async getProjectsRaw(requestParameters: GetProjectsRequest): Promise<runtime.ApiResponse<Array<ProjectResult>>> {
        if (requestParameters.companySlug === null || requestParameters.companySlug === undefined) {
            throw new runtime.RequiredError('companySlug','Required parameter requestParameters.companySlug was null or undefined when calling getProjects.');
        }
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => jsonValue.map(ProjectResultFromJSON));
    }

    /**
     * Returns all projects for given company
     */
    async getProjects(requestParameters: GetProjectsRequest): Promise<Array<ProjectResult>> {
     ...
     */
    async updateProjectRaw(requestParameters: UpdateProjectOperationRequest): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.companySlug === null || requestParameters.companySlug === undefined) {
            throw new runtime.RequiredError('companySlug','Required parameter requestParameters.companySlug was null or undefined when calling updateProject.');
        }
     ...
     * Updates project with provided id. 
     */
    async updateProject(requestParameters: UpdateProjectOperationRequest): Promise<void> {
        await this.updateProjectRaw(requestParameters);
    }
