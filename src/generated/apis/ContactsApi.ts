...
export interface AddContactPersonToContactRequest {
    companySlug: string;
    contactId: number;
...
export interface DeleteContactContactPersonRequest {
    companySlug: string;
    contactId: number;
...
export interface GetContactContactPersonRequest {
    companySlug: string;
    contactId: number;
}
...
export interface UpdateContactContactPersonRequest {
    companySlug: string;
    contactId: number;
    contactPersonId: number;
    contactPerson: ContactPerson;
...
export class ContactsApi extends runtime.BaseAPI {
     ...
     */
    async addContactPersonToContactRaw(requestParameters: AddContactPersonToContactRequest): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.companySlug === null || requestParameters.companySlug === undefined) {
            throw new runtime.RequiredError('companySlug','Required parameter requestParameters.companySlug was null or undefined when calling addContactPersonToContact.');
        }

        if (requestParameters.contactId === null || requestParameters.contactId === undefined) {
            throw new runtime.RequiredError('contactId','Required parameter requestParameters.contactId was null or undefined when calling addContactPersonToContact.');
        }

        if (requestParameters.contactPerson === null || requestParameters.contactPerson === undefined) {
            throw new runtime.RequiredError('contactPerson','Required parameter requestParameters.contactPerson was null or undefined when calling addContactPersonToContact.');
        }
        ...
        const response = await this.request({
            path: `/companies/{companySlug}/contacts/{contactId}/contactPerson`.replace(`{${"companySlug"}}`, encodeURIComponent(String(requestParameters.companySlug))).replace(`{${"contactId"}}`, encodeURIComponent(String(requestParameters.contactId))),
            method: 'POST',
     ...
     * Adds a new contact person to a contact
     */
    async addContactPersonToContact(requestParameters: AddContactPersonToContactRequest): Promise<void> {
        await this.addContactPersonToContactRaw(requestParameters);
    }

    /**
     * Creates a new contact. The Location response header returns the URL of the newly created contact.
     */
    async createContactRaw(requestParameters: CreateContactRequest): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.companySlug === null || requestParameters.companySlug === undefined) {
            throw new runtime.RequiredError('companySlug','Required parameter requestParameters.companySlug was null or undefined when calling createContact.');
        }
        ...
        const response = await this.request({
            path: `/companies/{companySlug}/contacts`.replace(`{${"companySlug"}}`, encodeURIComponent(String(requestParameters.companySlug))),
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
     ...
     * Creates a new contact. The Location response header returns the URL of the newly created contact.
     */
    async createContact(requestParameters: CreateContactRequest): Promise<void> {
        await this.createContactRaw(requestParameters);
    }

    /**
     * Delete a contact\'s contact person.
     */
    async deleteContactContactPersonRaw(requestParameters: DeleteContactContactPersonRequest): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.companySlug === null || requestParameters.companySlug === undefined) {
            throw new runtime.RequiredError('companySlug','Required parameter requestParameters.companySlug was null or undefined when calling deleteContactContactPerson.');
        }

        if (requestParameters.contactId === null || requestParameters.contactId === undefined) {
            throw new runtime.RequiredError('contactId','Required parameter requestParameters.contactId was null or undefined when calling deleteContactContactPerson.');
        }

        if (requestParameters.contactPersonId === null || requestParameters.contactPersonId === undefined) {
            throw new runtime.RequiredError('contactPersonId','Required parameter requestParameters.contactPersonId was null or undefined when calling deleteContactContactPerson.');
        }
        ...
        const response = await this.request({
            path: `/companies/{companySlug}/contacts/{contactId}/contactPerson/{contactPersonId}`.replace(`{${"companySlug"}}`, encodeURIComponent(String(requestParameters.companySlug))).replace(`{${"contactId"}}`, encodeURIComponent(String(requestParameters.contactId))).replace(`{${"contactPersonId"}}`, encodeURIComponent(String(requestParameters.contactPersonId))),
            method: 'DELETE',
            headers: headerParameters,
            query: queryParameters,
        });
     ...
     * Delete a contact\'s contact person.
     */
    async deleteContactContactPerson(requestParameters: DeleteContactContactPersonRequest): Promise<void> {
        await this.deleteContactContactPersonRaw(requestParameters);
    }
     ...
     */
    async getContactRaw(requestParameters: GetContactRequest): Promise<runtime.ApiResponse<Contact>> {
        if (requestParameters.companySlug === null || requestParameters.companySlug === undefined) {
            throw new runtime.RequiredError('companySlug','Required parameter requestParameters.companySlug was null or undefined when calling getContact.');
        }
        ...
        const response = await this.request({
            path: `/companies/{companySlug}/contacts/{contactId}`.replace(`{${"companySlug"}}`, encodeURIComponent(String(requestParameters.companySlug))).replace(`{${"contactId"}}`, encodeURIComponent(String(requestParameters.contactId))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        });
     ...
     * Retrieves specified contact. ContactId is returned with a GET contacts call as the first returned field. ContactId is returned in the Location response header for POST contact. 
     */
    async getContact(requestParameters: GetContactRequest): Promise<Contact> {
     ...
     */
    async getContactContactPersonRaw(requestParameters: GetContactContactPersonRequest): Promise<runtime.ApiResponse<Array<ContactPerson>>> {
        if (requestParameters.companySlug === null || requestParameters.companySlug === undefined) {
            throw new runtime.RequiredError('companySlug','Required parameter requestParameters.companySlug was null or undefined when calling getContactContactPerson.');
        }

        if (requestParameters.contactId === null || requestParameters.contactId === undefined) {
            throw new runtime.RequiredError('contactId','Required parameter requestParameters.contactId was null or undefined when calling getContactContactPerson.');
        }
     ...
     * Retrieves contact person(s) for a specified contact. 
     */
    async getContactContactPerson(requestParameters: GetContactContactPersonRequest): Promise<Array<ContactPerson>> {
        const response = await this.getContactContactPersonRaw(requestParameters);
        return await response.value();
    }
     ...
     */
    async getContactPersonRaw(requestParameters: GetContactPersonRequest): Promise<runtime.ApiResponse<ContactPerson>> {
        if (requestParameters.companySlug === null || requestParameters.companySlug === undefined) {
            throw new runtime.RequiredError('companySlug','Required parameter requestParameters.companySlug was null or undefined when calling getContactPerson.');
        }
     ...
     * Retrieves specified contact person 
     */
    async getContactPerson(requestParameters: GetContactPersonRequest): Promise<ContactPerson> {
        const response = await this.getContactPersonRaw(requestParameters);
        return await response.value();
    }
     ...
     */
    async getContactsRaw(requestParameters: GetContactsRequest): Promise<runtime.ApiResponse<Array<Contact>>> {
        if (requestParameters.companySlug === null || requestParameters.companySlug === undefined) {
            throw new runtime.RequiredError('companySlug','Required parameter requestParameters.companySlug was null or undefined when calling getContacts.');
        }
        ...
        if (requestParameters.supplierNumber !== undefined) {
            queryParameters['supplierNumber'] = requestParameters.supplierNumber;
        }
        ...
        if (requestParameters.memberNumber !== undefined) {
            queryParameters['memberNumber'] = requestParameters.memberNumber;
        }
        ...
        if (requestParameters.organizationNumber !== undefined) {
            queryParameters['organizationNumber'] = requestParameters.organizationNumber;
        }
     ...
     * Retrieves all contacts for the specified company.
     */
    async getContacts(requestParameters: GetContactsRequest): Promise<Array<Contact>> {
    ...
    async updateContactRaw(requestParameters: UpdateContactRequest): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.companySlug === null || requestParameters.companySlug === undefined) {
            throw new runtime.RequiredError('companySlug','Required parameter requestParameters.companySlug was null or undefined when calling updateContact.');
        }
     ...
     */
    async updateContactContactPersonRaw(requestParameters: UpdateContactContactPersonRequest): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.companySlug === null || requestParameters.companySlug === undefined) {
            throw new runtime.RequiredError('companySlug','Required parameter requestParameters.companySlug was null or undefined when calling updateContactContactPerson.');
        }

        if (requestParameters.contactId === null || requestParameters.contactId === undefined) {
            throw new runtime.RequiredError('contactId','Required parameter requestParameters.contactId was null or undefined when calling updateContactContactPerson.');
        }

        if (requestParameters.contactPersonId === null || requestParameters.contactPersonId === undefined) {
            throw new runtime.RequiredError('contactPersonId','Required parameter requestParameters.contactPersonId was null or undefined when calling updateContactContactPerson.');
        }

        if (requestParameters.contactPerson === null || requestParameters.contactPerson === undefined) {
            throw new runtime.RequiredError('contactPerson','Required parameter requestParameters.contactPerson was null or undefined when calling updateContactContactPerson.');
        }
     ...
     * Updates an existing contact person.
     */
    async updateContactContactPerson(requestParameters: UpdateContactContactPersonRequest): Promise<void> {
        await this.updateContactContactPersonRaw(requestParameters);
    }
