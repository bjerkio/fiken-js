...
export interface GetInboxRequest {
    ...
    page?: number;
    pageSize?: number;
    sortBy?: GetInboxSortByEnum;
    status?: GetInboxStatusEnum;
    name?: string;
}

export interface GetInboxDocumentRequest {
    companySlug: string;
...
export class InboxApi extends runtime.BaseAPI {
     ...
     */
    async createInboxDocumentRaw(requestParameters: CreateInboxDocumentRequest): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.companySlug === null || requestParameters.companySlug === undefined) {
            throw new runtime.RequiredError('companySlug','Required parameter requestParameters.companySlug was null or undefined when calling createInboxDocument.');
        }
     ...
     * Upload a document to the inbox
     */
    async createInboxDocument(requestParameters: CreateInboxDocumentRequest): Promise<void> {
        await this.createInboxDocumentRaw(requestParameters);
    }

    /**
     * Returns the contents of the inbox for given company.
     */
    async getInboxRaw(requestParameters: GetInboxRequest): Promise<runtime.ApiResponse<Array<InboxResult>>> {
        if (requestParameters.companySlug === null || requestParameters.companySlug === undefined) {
            throw new runtime.RequiredError('companySlug','Required parameter requestParameters.companySlug was null or undefined when calling getInbox.');
        }
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => jsonValue.map(InboxResultFromJSON));
    }

    /**
     * Returns the contents of the inbox for given company.
     */
    async getInbox(requestParameters: GetInboxRequest): Promise<Array<InboxResult>> {
     ...
     */
    async getInboxDocumentRaw(requestParameters: GetInboxDocumentRequest): Promise<runtime.ApiResponse<InboxResult>> {
        if (requestParameters.companySlug === null || requestParameters.companySlug === undefined) {
            throw new runtime.RequiredError('companySlug','Required parameter requestParameters.companySlug was null or undefined when calling getInboxDocument.');
        }

        if (requestParameters.inboxDocumentId === null || requestParameters.inboxDocumentId === undefined) {
            throw new runtime.RequiredError('inboxDocumentId','Required parameter requestParameters.inboxDocumentId was null or undefined when calling getInboxDocument.');
        }
        ...
        const response = await this.request({
            path: `/companies/{companySlug}/inbox/{inboxDocumentId}`.replace(`{${"companySlug"}}`, encodeURIComponent(String(requestParameters.companySlug))).replace(`{${"inboxDocumentId"}}`, encodeURIComponent(String(requestParameters.inboxDocumentId))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        });

        return new runtime.JSONApiResponse(response, (jsonValue) => InboxResultFromJSON(jsonValue));
    }

    /**
     * Returns the inbox document with specified id
     */
    async getInboxDocument(requestParameters: GetInboxDocumentRequest): Promise<InboxResult> {
        const response = await this.getInboxDocumentRaw(requestParameters);
        return await response.value();
    }
...
/**
    ...
    * @enum {string}
    */
export enum GetInboxSortByEnum {
...
/**
    ...
    * @enum {string}
    */
export enum GetInboxStatusEnum {
    All = 'all',
    Unused = 'unused',
    Used = 'used'
}
