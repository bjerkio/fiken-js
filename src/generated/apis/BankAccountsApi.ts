...
export class BankAccountsApi extends runtime.BaseAPI {
     ...
     */
    async createBankAccountRaw(requestParameters: CreateBankAccountRequest): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.companySlug === null || requestParameters.companySlug === undefined) {
            throw new runtime.RequiredError('companySlug','Required parameter requestParameters.companySlug was null or undefined when calling createBankAccount.');
        }

        if (requestParameters.bankAccountRequest === null || requestParameters.bankAccountRequest === undefined) {
            throw new runtime.RequiredError('bankAccountRequest','Required parameter requestParameters.bankAccountRequest was null or undefined when calling createBankAccount.');
        }
        ...
        const response = await this.request({
            path: `/companies/{companySlug}/bankAccounts`.replace(`{${"companySlug"}}`, encodeURIComponent(String(requestParameters.companySlug))),
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
            body: BankAccountRequestToJSON(requestParameters.bankAccountRequest),
        });
     ...
     * Creates a new bank account. The Location response header returns the URL of the newly created bank account. Possible types of bank accounts are NORMAL, TAX_DEDUCTION, FOREIGN, and CREDIT_CARD. The field \"foreignService\" should only be filled out for accounts of type FOREIGN. 
     */
    async createBankAccount(requestParameters: CreateBankAccountRequest): Promise<void> {
        await this.createBankAccountRaw(requestParameters);
    }

    /**
     * Retrieves specified bank account.
     */
    async getBankAccountRaw(requestParameters: GetBankAccountRequest): Promise<runtime.ApiResponse<BankAccountResult>> {
        if (requestParameters.companySlug === null || requestParameters.companySlug === undefined) {
            throw new runtime.RequiredError('companySlug','Required parameter requestParameters.companySlug was null or undefined when calling getBankAccount.');
        }
        ...
        const response = await this.request({
            path: `/companies/{companySlug}/bankAccounts/{bankAccountId}`.replace(`{${"companySlug"}}`, encodeURIComponent(String(requestParameters.companySlug))).replace(`{${"bankAccountId"}}`, encodeURIComponent(String(requestParameters.bankAccountId))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        });

        return new runtime.JSONApiResponse(response, (jsonValue) => BankAccountResultFromJSON(jsonValue));
    }

    /**
     * Retrieves specified bank account.
     */
    async getBankAccount(requestParameters: GetBankAccountRequest): Promise<BankAccountResult> {
        const response = await this.getBankAccountRaw(requestParameters);
     ...
     */
    async getBankAccountsRaw(requestParameters: GetBankAccountsRequest): Promise<runtime.ApiResponse<Array<BankAccountResult>>> {
        if (requestParameters.companySlug === null || requestParameters.companySlug === undefined) {
            throw new runtime.RequiredError('companySlug','Required parameter requestParameters.companySlug was null or undefined when calling getBankAccounts.');
        }
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => jsonValue.map(BankAccountResultFromJSON));
    }

    /**
     * Retrieves all bank accounts associated with the company.
     */
    async getBankAccounts(requestParameters: GetBankAccountsRequest): Promise<Array<BankAccountResult>> {
        const response = await this.getBankAccountsRaw(requestParameters);
        return await response.value();
    }
