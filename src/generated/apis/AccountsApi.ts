...
export class AccountsApi extends runtime.BaseAPI {
    ...
    async getAccountRaw(requestParameters: GetAccountRequest): Promise<runtime.ApiResponse<Account>> {
        if (requestParameters.companySlug === null || requestParameters.companySlug === undefined) {
            throw new runtime.RequiredError('companySlug','Required parameter requestParameters.companySlug was null or undefined when calling getAccount.');
        }

        if (requestParameters.accountCode === null || requestParameters.accountCode === undefined) {
            throw new runtime.RequiredError('accountCode','Required parameter requestParameters.accountCode was null or undefined when calling getAccount.');
        }
        ...
        const response = await this.request({
            path: `/companies/{companySlug}/accounts/{accountCode}`.replace(`{${"companySlug"}}`, encodeURIComponent(String(requestParameters.companySlug))).replace(`{${"accountCode"}}`, encodeURIComponent(String(requestParameters.accountCode))),
            method: 'GET',
     ...
     * Retrieves the specified bookkeping account. An account is a string with either four digits, or four digits, a colon and five digits (\"reskontro\").       Examples:       3020 and 1500:10001 
     */
    async getAccount(requestParameters: GetAccountRequest): Promise<Account> {
     ...
     */
    async getAccountBalanceRaw(requestParameters: GetAccountBalanceRequest): Promise<runtime.ApiResponse<AccountBalance>> {
        if (requestParameters.companySlug === null || requestParameters.companySlug === undefined) {
            throw new runtime.RequiredError('companySlug','Required parameter requestParameters.companySlug was null or undefined when calling getAccountBalance.');
        }

        if (requestParameters.accountCode === null || requestParameters.accountCode === undefined) {
            throw new runtime.RequiredError('accountCode','Required parameter requestParameters.accountCode was null or undefined when calling getAccountBalance.');
        }

        if (requestParameters.date === null || requestParameters.date === undefined) {
            throw new runtime.RequiredError('date','Required parameter requestParameters.date was null or undefined when calling getAccountBalance.');
        }
        ...
        const response = await this.request({
            path: `/companies/{companySlug}/accountBalances/{accountCode}`.replace(`{${"companySlug"}}`, encodeURIComponent(String(requestParameters.companySlug))).replace(`{${"accountCode"}}`, encodeURIComponent(String(requestParameters.accountCode))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        });
     ...
     * Retrieves the specified bookkeping account and balance for a given date.
     */
    async getAccountBalance(requestParameters: GetAccountBalanceRequest): Promise<AccountBalance> {
     ...
     */
    async getAccountBalancesRaw(requestParameters: GetAccountBalancesRequest): Promise<runtime.ApiResponse<Array<AccountBalance>>> {
        if (requestParameters.companySlug === null || requestParameters.companySlug === undefined) {
            throw new runtime.RequiredError('companySlug','Required parameter requestParameters.companySlug was null or undefined when calling getAccountBalances.');
        }

        if (requestParameters.date === null || requestParameters.date === undefined) {
            throw new runtime.RequiredError('date','Required parameter requestParameters.date was null or undefined when calling getAccountBalances.');
        }

        const queryParameters: any = {};

        if (requestParameters.fromAccount !== undefined) {
            queryParameters['fromAccount'] = requestParameters.fromAccount;
        }

        if (requestParameters.toAccount !== undefined) {
            queryParameters['toAccount'] = requestParameters.toAccount;
        }
        ...
        const response = await this.request({
            path: `/companies/{companySlug}/accountBalances`.replace(`{${"companySlug"}}`, encodeURIComponent(String(requestParameters.companySlug))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        });
     ...
     * Retrieves the bookkeeping accounts and balances for a given date. An account is a string with either four digits, or four digits, a colon and five digits (\"reskontro\"). Examples: 3020 and 1500:10001 
     */
    async getAccountBalances(requestParameters: GetAccountBalancesRequest): Promise<Array<AccountBalance>> {
        const response = await this.getAccountBalancesRaw(requestParameters);
        return await response.value();
    }
    ...
    async getAccountsRaw(requestParameters: GetAccountsRequest): Promise<runtime.ApiResponse<Array<Account>>> {
        if (requestParameters.companySlug === null || requestParameters.companySlug === undefined) {
            throw new runtime.RequiredError('companySlug','Required parameter requestParameters.companySlug was null or undefined when calling getAccounts.');
        }
        ...
        const response = await this.request({
            path: `/companies/{companySlug}/accounts`.replace(`{${"companySlug"}}`, encodeURIComponent(String(requestParameters.companySlug))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        });
     ...
     * Retrieves the bookkeeping accounts for the current year 
     */
    async getAccounts(requestParameters: GetAccountsRequest): Promise<Array<Account>> {
