...
export interface CreateProductSalesReportRequest {
    companySlug: string;
...
export class ProductsApi extends runtime.BaseAPI {
     ...
     */
    async createProductRaw(requestParameters: CreateProductRequest): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.companySlug === null || requestParameters.companySlug === undefined) {
            throw new runtime.RequiredError('companySlug','Required parameter requestParameters.companySlug was null or undefined when calling createProduct.');
        }
        ...
        const response = await this.request({
            path: `/companies/{companySlug}/products`.replace(`{${"companySlug"}}`, encodeURIComponent(String(requestParameters.companySlug))),
            method: 'POST',
     ...
     * Creates a new product.
     */
    async createProduct(requestParameters: CreateProductRequest): Promise<void> {
        await this.createProductRaw(requestParameters);
    }

    /**
     * Creates a report based on provided specifications.
     */
    async createProductSalesReportRaw(requestParameters: CreateProductSalesReportRequest): Promise<runtime.ApiResponse<Array<ProductSalesReportResult>>> {
        if (requestParameters.companySlug === null || requestParameters.companySlug === undefined) {
            throw new runtime.RequiredError('companySlug','Required parameter requestParameters.companySlug was null or undefined when calling createProductSalesReport.');
        }

        if (requestParameters.productSalesReportRequest === null || requestParameters.productSalesReportRequest === undefined) {
            throw new runtime.RequiredError('productSalesReportRequest','Required parameter requestParameters.productSalesReportRequest was null or undefined when calling createProductSalesReport.');
        }
        ...
        const response = await this.request({
            path: `/companies/{companySlug}/products/salesReport`.replace(`{${"companySlug"}}`, encodeURIComponent(String(requestParameters.companySlug))),
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
            body: ProductSalesReportRequestToJSON(requestParameters.productSalesReportRequest),
        });

        return new runtime.JSONApiResponse(response, (jsonValue) => jsonValue.map(ProductSalesReportResultFromJSON));
    }

    /**
     * Creates a report based on provided specifications.
     */
    async createProductSalesReport(requestParameters: CreateProductSalesReportRequest): Promise<Array<ProductSalesReportResult>> {
        const response = await this.createProductSalesReportRaw(requestParameters);
    ...
    async deleteProductRaw(requestParameters: DeleteProductRequest): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.companySlug === null || requestParameters.companySlug === undefined) {
            throw new runtime.RequiredError('companySlug','Required parameter requestParameters.companySlug was null or undefined when calling deleteProduct.');
        }
        ...
        const response = await this.request({
            path: `/companies/{companySlug}/products/{productId}`.replace(`{${"companySlug"}}`, encodeURIComponent(String(requestParameters.companySlug))).replace(`{${"productId"}}`, encodeURIComponent(String(requestParameters.productId))),
            method: 'DELETE',
            headers: headerParameters,
            query: queryParameters,
        });
     ...
     */
    async getProductRaw(requestParameters: GetProductRequest): Promise<runtime.ApiResponse<Product>> {
        if (requestParameters.companySlug === null || requestParameters.companySlug === undefined) {
            throw new runtime.RequiredError('companySlug','Required parameter requestParameters.companySlug was null or undefined when calling getProduct.');
        }
     ...
     * Returns product with specified id.
     */
    async getProduct(requestParameters: GetProductRequest): Promise<Product> {
    ...
    async getProductsRaw(requestParameters: GetProductsRequest): Promise<runtime.ApiResponse<Array<Product>>> {
        if (requestParameters.companySlug === null || requestParameters.companySlug === undefined) {
            throw new runtime.RequiredError('companySlug','Required parameter requestParameters.companySlug was null or undefined when calling getProducts.');
        }
    ...
    async updateProductRaw(requestParameters: UpdateProductRequest): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.companySlug === null || requestParameters.companySlug === undefined) {
            throw new runtime.RequiredError('companySlug','Required parameter requestParameters.companySlug was null or undefined when calling updateProduct.');
        }
